...
const CATEGORY_OPTIONS = [
  ...
  { key: 'tools-accessories', category: 'tools-accessories', tags: [], label: 'Tools' },
  { key: 'accessories', category: 'accessories', tags: [], label: 'Accessories' },
...
export default function ProductEdit() {
      ...
      try {
        ...
        if (product) {
          ...
          const formData = {
            ...
            isInStock: !product.out_of_stock && ((product.inventory_quantity || product.stock || product.stock_on_hand || product.stock_qty || 0) > 0 || product.out_of_stock === false),
  ...
  const cardModel = useMemo(
    ...
    [badges, form.id, form.name, form.short_description, form.slug, form.status, inStock, previewImages, priceNumber, compareAtNumber]
  );
